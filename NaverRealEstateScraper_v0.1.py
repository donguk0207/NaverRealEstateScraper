...
tableview = ttk.Treeview(list_frame, columns=["atclCfmYmd", "rletTpNm", "tradTpNm", "prc", "spc1", "spc2", "hanPrc", "rentPrc", "atclFetrDesc", "tagList", "detaild_information"], \
                         displaycolumns=["atclCfmYmd", "rletTpNm", "tradTpNm", "prc", "spc1", "spc2", "hanPrc", "rentPrc", "atclFetrDesc", "tagList", "detaild_information"], \
